...
@push('head')
    <link rel="preload" as="image" href="{{ asset('assets/images/landing/hero-petani.webp') }}" type="image/webp">
@endpush
...
@section('content')
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 order-lg-1">
                    <div class="hero-text">
                        ...
                        <h1 class="hero-title">
                            Deteksi <span>Penyakit & Hama</span> Tanaman Jagung
                        </h1>
                        <p class="hero-desc">
                            SIPATAN membantu petani dan penyuluh pertanian mendiagnosis penyakit dan hama
                            pada tanaman jagung secara interaktif. Pilih gejala yang Anda amati,
                            lalu dapatkan rekomendasi solusi berdasarkan metode Certainty Factor.
                        </p>
                        <div class="hero-buttons d-flex flex-wrap gap-3">
                            <a href="{{ route('deteksi') }}" class="btn btn-warning btn-lg">
                            ...
                            @else
                                @if (auth()->user()->isStaff())
                                    <a href="{{ route('dashboard') }}" class="btn btn-outline-warning btn-lg">
                                        <i class="ti ti-layout-dashboard me-2"></i>Dashboard Admin
                                    </a>
                                @else
                                    <a href="{{ route('riwayat') }}" class="btn btn-outline-warning btn-lg">
                ...
                <div class="col-lg-6 order-lg-2">
                    <div class="hero-image-wrap mx-auto text-center">
                        <x-landing-picture src="assets/images/landing/hero-petani.jpg" alt="Petani memeriksa tanaman jagung di ladang" class="img-fluid hero-photo" width="800" height="533" fetchpriority="high" />
                        <div class="floating-badge top-left">
                            <div class="icon bg-warning-subtle text-warning"><i class="ti ti-leaf"></i></div>
                            <div>
    ...
    {{-- Komoditas --}}
    <section class="komoditas-section">
        <div class="komoditas-gradient-bg" aria-hidden="true">
            <span class="komoditas-blob komoditas-blob-jagung"></span>
        </div>
        <div class="container position-relative">
            <div class="row g-4 g-lg-5 align-items-center komoditas-split">
                <div class="col-lg-5 komoditas-split-intro">
                    <span class="section-tag"><i class="ti ti-plant me-1"></i> Komoditas</span>
                    <h2 class="section-title mb-3">Komoditas Jagung</h2>
                    <p class="text-muted mb-4">
                        SIPATAN mendukung diagnosa penyakit dan hama pada tanaman jagung.
                        Ikuti langkah deteksi gejala secara interaktif untuk mendapatkan hasil diagnosis.
                    </p>
                    <ul class="komoditas-highlights list-unstyled mb-0">
                        <li>
                            <span class="komoditas-highlight-icon komoditas-highlight-jagung"><i class="ti ti-wheat"></i></span>
                            <span><strong>Jagung</strong> — deteksi gejala pada daun, batang, dan tongkol</span>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-7 komoditas-split-cards">
                    <div class="d-flex flex-column gap-3 gap-lg-4">
                        @foreach ($komoditasList as $item)
                            <a href="{{ route('deteksi.komoditas', $item->slug) }}"
                                class="komoditas-card komoditas-card-horizontal komoditas-card--{{ $item->slug }} text-decoration-none animate-on-scroll">
    ...
    <section class="features-section">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <h2 class="section-title"><i class="ti ti-leaf me-2 text-warning"></i>Mengapa SIPATAN?</h2>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-box text-center animate-on-scroll">
                <h2 class="fw-bold mb-3"><i class="ti ti-plant-2 me-2"></i>Siap Mendeteksi Penyakit Tanaman?</h2>
                <p class="mb-4 opacity-75 mx-auto" style="max-width:500px">
                    Mulai diagnosa tanaman jagung sekarang — gratis, tanpa perlu mendaftar. Hasil deteksi akan tersimpan untuk analisis di dashboard admin.
                </p>
