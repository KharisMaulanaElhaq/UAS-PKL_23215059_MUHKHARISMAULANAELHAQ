...
<head>
    ...
    <link rel="preload" as="image" href="{{ asset('assets/images/landing/bg-sawah.webp') }}" type="image/webp">
                ...
                <div class="d-flex align-items-center gap-2">
                    @auth
                        @if(auth()->user()->isStaff())
                            <a href="{{ route('dashboard') }}" class="btn btn-outline-warning btn-sm rounded-pill px-3">
                        ...
                        @endif
                    @else
                        <a href="{{ route('login') }}" class="btn btn-outline-warning btn-sm rounded-pill px-3">
                            <i class="ti ti-login me-1"></i> Masuk
                        </a>
                        <a href="{{ route('register') }}" class="btn btn-warning btn-sm rounded-pill px-3">
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-lg-4">
                    ...
                    <p class="text-white-50 small mb-0">Sistem Pakar Diagnosa Penyakit & Hama Tanaman Jagung berbasis Certainty Factor.</p>
                </div>
