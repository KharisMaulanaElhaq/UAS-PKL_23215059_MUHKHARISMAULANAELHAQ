...
class RulesCfExport
{
    ...
    public function download(string $filename): StreamedResponse
    {
        ...
        $headers = ['No', 'Jenis', 'Komoditas', 'Kode Target', 'Nama Target', 'Kode Gejala', 'Nama Gejala', 'Nilai CF'];
        ...
        foreach ($this->rules as $rule) {
            ...
            if ($rule->details->isEmpty()) {
                $sheet->fromArray([$no++, $jenis, $komoditas, $kodeTarget, $namaTarget, '', '', ''], null, "A{$row}");
                $row++;
